...
<link rel="stylesheet" href="{$rootUrl}/Okay/Modules/SimplaMarket/AdvancedCoupons/Backend/design/css/advanced_coupons.css">
    ...
    <div class="col-lg-7 col-md-7">
        <div class="wrap_heading">
            ...
            <div class="box_btn_heading fn_add_coupon">
                <a class="btn btn_small btn-info" href="{url controller='SimplaMarket.AdvancedCoupons.AdvancedCouponAdmin'}">
...
<div class="alert alert--icon alert--info">
    <div class="alert__content">
        ...
        <p>{$btr->sm_advanced_coupons_discount_dont_forget|escape}</p>
        <p>{$btr->sm_advanced_coupons_discount_instruction|escape}</p>
    </div>
</div>
        ...
        <form class="fn_form_list" method="post">
            ...
            <div class="okay_list products_list fn_sort_list">
                ...
                <div class="okay_list_head">
                    ...
                    <div class="okay_list_heading okay_list_advanced_coupon_name">{$btr->coupons_name|escape}</div>
...
{*                    <div class="okay_list_heading okay_list_advanced_coupon_summ">{$btr->coupons_summ|escape}</div>*}
                    ...
                    {foreach $coupons as $coupon}
                        <div class="fn_row okay_list_body_item">
                            <div class="okay_list_row ">
                                ...
                                <div class="okay_list_boding okay_list_advanced_coupon_name">
                                    <a href="{url controller='SimplaMarket.AdvancedCoupons.AdvancedCouponAdmin' id=$coupon->id return=$smarty.server.REQUEST_URI}}" class="text_dark">
                                        {$coupon->code}
                                    </a>
...
{*                                <div class="okay_list_boding okay_list_advanced_coupon_summ">*}
{*                                    {if $coupon->summ}*}
{*                                        {$btr->coupons_yes|escape}*}
{*                                    {else}*}
{*                                        {$btr->coupons_no|escape}*}
